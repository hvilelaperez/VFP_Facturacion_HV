...
*SELECT b.nombre,SUM(a.valorfob+a.valorflete+a.valorseguro) as valorcif FROM pedidoimp as a LEFT JOIN proveedores as b ON a.proveedor=b.codigo ;
       WHERE YEAR(fechapedido)=2015 AND anulado<>.t. AND tipoembarque<>'P' GROUP BY 1 INTO CURSOR midato
