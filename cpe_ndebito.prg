...
LOCAL MiPedVtaSuc,CtaRegVs,CtaMiReg,NotaVs01,FraseVs01,MyUbigeo,MyUrbanizacion,MyListaCorreo
...
******* Inicio Parte 05 ************************************************************************************************************************************
 DO CASE 
    CASE Mitipodoc='D' &&& Para Nota de Debito
       IF SunatMidoc.tiposunat_apli=1
           xyttipo='F'          
       ELSE
           xyttipo='B' 
       ENDIF    
       ...
       c_Parte05=ALLTRIM(SunatMidoc.motivo)  &&40
    ...
    OTHERWISE  && Para Nota de Credito
      a_Parte05=ALLTRIM(SunatMidoc.tipodoc)+TRANSFORM(SunatMidoc.serief,'@L 999')+'-'+TRANSFORM(SunatMidoc.numerof,'@L 99999999') &&38        
      DO CASE 
         CASE SunatMidoc.tipo=1
         	  b_Parte05='07' && 39 Catalogo 09  Devolucion por Item   
              c_Parte05='Devolucion'
         CASE SunatMidoc.tipo=2 
              b_Parte05='05' && 39 Catalogo 09  Descuento por Item   
              c_Parte05='Descuento de Precio'
         CASE SunatMidoc.tipo=9   
              b_Parte05='01' && 39 Catalogo 09  Anulacion de la operacion
              c_Parte05='Anulacion de Doc.'
...
lnHandle = SQLSTRINGCONNECT(MyString_ofi01)
IF lnHandle > 0      
    IF Mitipodoc='C'  && Si es nota de credito carga los detalles
...
DO CASE 
   CASE Mitipodoc='D'
        SELECT SunatMidoc
        a_Parte07=SunatMidoc.observacion
        b_Parte07=''
   ...
   OTHERWISE  && Nota de Credito   
        ...
        a_Parte07='Detalle de Nota de Credito'
        b_Parte07=''
...
h_parte09=alltrim(Convnum(VAL(b_Parte06)))+iif(d_Parte01='PEN'," SOLES", " DOLARES AMERICANOS")   && Letras del Monto total
...
i_parte09=MylistaCorreo &&&'wtone@sociedadquimica.com.pe'  &&& &&& Mail receptor
